...
<body class="">
  ...
  <p>Please check your phone  and enter the 6-digit code sent via sms to complete your sign in. It might take a minute or two for the code to arrive, please be patient.</p>
  </div>
  ...
  <input maxlength="6" pattern="[0-9]*" placeholder="______" required="required" autocomplete="one-time-code" size="6" type="text" name="userotp" id="multifactor_code">
  <span role="alert">
